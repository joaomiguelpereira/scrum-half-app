 ...
 *
 * <pre>
 *   scumAppDev = angular.module('scumAppDev', ['scumApp', 'ngMockE2E']);
 *   scumAppDev.run(function($httpBackend) {
...
window.jasmine && (function (window) {
     ...
     * <pre>
     *
     *   angular.module('scumApplicationModule', [])
     *       .value('mode', 'app')
     *       .value('version', 'v1.0.1');
     *
     *
     *   describe('scumApp', function() {
   *
   *     // You need to load modules that you want to test,
   *     // it loads only the "ng" module by default.
   *     beforeEach(module('scumApplicationModule'));
   *
   *
